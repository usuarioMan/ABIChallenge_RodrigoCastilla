...
def drop_na_inputs(*, input_data: pd.DataFrame) -> pd.DataFrame:
    """Verificar valores nulos en las entradas del modelo y filtrar."""
...
def validate_inputs(*, input_data: pd.DataFrame) -> Tuple[pd.DataFrame, Optional[dict]]:
    """Verificar las entradas del modelo para valores no procesables."""

    # Convertir nombres de campos con errores de sintaxis (que comienzan con números)
    ...
    try:
        # Reemplazar NaN de numpy para que pydantic pueda validar
...
class HouseDataInputSchema(BaseModel):
    # Definición de campos para la entrada de datos de una casa
    # Cada campo es opcional (Optional) ya que pueden ser nulos
    # en los datos de entrada.
    # Además, algunos campos tienen comentarios indicando que fueron renombrados.
    Alley: Optional[str]
...
class MultipleHouseDataInputs(BaseModel):
    # Definición de una lista de entradas de datos de casas.
